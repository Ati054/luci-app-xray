...
sh "${SCRIPT_DIR}/test_verify_package_contents.sh"
sh "${SCRIPT_DIR}/test_package_import_failure_reporting.sh"
sh "${SCRIPT_DIR}/test_package_imports.sh"
PYTHONDONTWRITEBYTECODE=1 "${PYTHON_BIN}" "${SCRIPT_DIR}/test_r10_contracts.py"
PYTHONDONTWRITEBYTECODE=1 "${PYTHON_BIN}" "${SCRIPT_DIR}/test_r10_manifest.py"
PYTHONDONTWRITEBYTECODE=1 "${PYTHON_BIN}" "${SCRIPT_DIR}/test_workflow_shell.py"
sh "${SCRIPT_DIR}/test_installer_r10.sh"
