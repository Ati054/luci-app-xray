...
* 2026-09-07 fix: connection-aware per-profile recovery waits out long server outages, performs one targeted restart when the peer returns, and suppresses restart storms
